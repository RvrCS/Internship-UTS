...
export class SidebarService {
  private initialSidebar: ISidebar = { containerClassnames: environment.defaultMenuType, menuClickCount: 0, 
  ...
  changeVal(str: string) {
    ...
    this.sidebar.next({ containerClassnames: str, menuClickCount: before.menuClickCount, 
  ...
  clickOnMobileMenu = (strCurrentClasses: string) => {
    ...
    this.sidebar.next({ containerClassnames: nextClasses, menuClickCount: 0, 
      selectedMenuHasSubItems: before.selectedMenuHasSubItems });
  }
}
